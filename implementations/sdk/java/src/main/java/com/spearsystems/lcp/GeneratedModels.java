...
public final class GeneratedModels {
    ...
    public record LeadPayload(String leadId, String status, String channel, Object consumer, Object location, Map<String, Object> attributes, String externalId, String submittedAt, Object compliance, Object provenance, Object exclusivity, Object contactWindow, Object leadQuality, Object expiry) {}
    public record CallPayload(String leadId, String status, String channel, Object consumer, Object location, Object call, String externalId, String submittedAt, Object compliance, Object provenance, Map<String, Object> attributes, Object expiry, Object exclusivity) {}
    ...
    public record PostPayload(String leadId, String deliveredAt, int priceCents, String currency, String buyerId, Object consumer, Object location, Map<String, Object> attributes, String submittedAt, String offerId, String buyerReference, Object pricing, Object compliance, Object provenance) {}
    ...
    public record OfferModel(String offerId, String buyerId, String vertical, List<String> countries, int floorPriceCents, String currency, String tenantId, boolean active, String routingMode, String schemaVersion, Map<String, Object> extensions) {}
}
