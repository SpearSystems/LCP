...
This project is indexed by GitNexus as **LCP** (3319 symbols, 6012 relationships, 256 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
