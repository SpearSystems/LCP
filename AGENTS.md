...
This project is indexed by GitNexus as **LCP** (3416 symbols, 6172 relationships, 260 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
