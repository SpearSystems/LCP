...
This project is indexed by GitNexus as **LCP** (3306 symbols, 6034 relationships, 241 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
