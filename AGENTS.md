...
This project is indexed by GitNexus as **LCP** (2839 symbols, 5433 relationships, 241 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
